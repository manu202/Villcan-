...
**Phase 3 — Hygiene and coherence before selling packages:**
9. H-1 — remove committed CSV/py data files from the repo.
10. S-1/S-4 — confirm or apply `service-images` storage, with branch isolation.
11. Decide and execute for real: `split_payment_enabled`, "Arqueo obligatorio", inventory — build them properly or remove the toggle/claim.
